...
function EditTaskPage (){
    ...
    const[taskTypeEditable, setTaskTypeEditable] = useState(false)
    ...
    const[activityTypeEditable, setActivityTypeEditable] = useState(false)
    const[taskFrequencyEditable, setTaskFrequencyEditable] = useState(false)
    const[documentationRequiredEditable, setDocumentationRequiredEditable] = useState(false)
    const[documentationStatusEditable, setDocumentationStatusEditable] = useState(false)
    const[taskPriorityEditable, setTaskPriorityEditable] = useState(false)
    const[taskJobTypeEditable, setTaskJobTypeEditable] = useState(false)
    const[currentStatusEditable, setCurrentStatusEditable] = useState(false)
    const[assignedToEditable, setAssignedToEditable] = useState(false)
        ...
        axios.post(BASE_URL+'task', data).then((response) => {
            if(response.data == "Data issues"){
                ...
                response.data.map((task, count) =>{
                    ...
                    setCompletedDateValue(response.data[0].completion_Dt);
                        ...
                        <div className='col-12 d-flex mt-2'>
                            <div className='col-8 pt-2'>
                                ...
                                <div className='d-flex col-11 mt-3'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        taskTypeEditable === false ?
                                        <span onClick={()=>setTaskTypeEditable(true)}>
                                            {
                                                taskType.map((task, count) =>{
                                                    if (String(task.id) === String(taskTypeValue)) {
                                                        return <span className='task-span-text'>{task.name}</span>;
                                                    }
                                                })
                                            }
                                        </span>
                                ...
                                <div className='d-flex col-11 mt-1'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        ...
                                        <span onClick={()=>setActivityTypeEditable(true)}>
                                            {
                                                activityType.map((activity, count) =>{
                                                    if (String(activity.id) === String(activityTypeValue)) {
                                                        return <span className='task-span-text'>{activity.activity}</span>;
                                                    }
                                                })
                                            }
                                        </span>
                                ...
                                <div className='d-flex col-11 mt-1 mb-3'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        taskFrequencyEditable === false ?
                                        <span onClick={()=>setTaskFrequencyEditable(true)}>
                                        {
                                            taskFrequency.map((frequency, count) =>{
                                                if (String(frequency.id) === String(taskFrequencyValue)) {
                                                    return <span className='task-span-text'>{frequency.frequency}</span>;
                                                }
                                            })
                                        }
                                        </span>
                                ...
                                <div className='d-flex col-11 mt-3'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        documentationRequiredEditable === false ?
                                        <span className='task-span-text' onClick={()=>setDocumentationRequiredEditable(true)}>{documentationRequiredValue === true ? "Yes" : "No"}</span>
                                        :
                                ...
                                <div className='d-flex col-11 mt-1 mb-5'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        documentationStatusEditable === false ? 
                                        <span onClick={()=>setDocumentationStatusEditable(true)}>
                                        {
                                            documentationStatus.map((status, count) =>{
                                                if (String(status.id) === String(documentationStatusValue)) {
                                                    return <span className='task-span-text'>{status.docStatus}</span>;
                                                }
                                                else if(count === 0){
                                                    return <span className='task-span-text'>{status.docStatus}</span>;
                                                } 
                            ...
                            <div className='col-4'>
                                ...
                                <div className='d-flex col-11 mt-3'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        taskPriorityEditable === false ?
                                        <span onClick={()=>setTaskPriorityEditable(true)}>
                                        {
                                            priority.map((prio, count) =>{
                                                if (String(prio.id) === String(priorityValue)) {
                                                    return <span className='task-span-text'>{prio.priority}</span>;
                                                }
                                            })
                                        }
                                        </span>
                                ...
                                <div className='d-flex col-11 mt-1'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        taskJobTypeEditable === false ?
                                        <span onClick={()=>setTaskJobTypeEditable(true)}>
                                        {
                                            taskJobType.map((type, count) =>{
                                                if (String(type.id) === String(taskJobTypeValue)) {
                                                    return <span className='task-span-text'>{type.taskJob}</span>;
                                                }
                                            })
                                        }
                                        </span>
                                ...
                                <div className='d-flex col-11 mt-1 mb-3'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        currentStatusEditable === false ?
                                        <span className='task-span-text' onClick={()=>setCurrentStatusEditable(true)}>{currentStatusValue}</span>
                                        :
                                        <div className='d-flex align-items-center'>
                                            <select name='currentstatus' id='currentstatus-dropdown' className='priority-dropdown mt-1' onChange={(event)=>setCurrentStatusValue(event.target.value)}>
                                ...
                                <div className='d-flex col-11 mt-2'>
                                    ...
                                    <div className='col-6'>
                                    {
                                        assignedToEditable === false ?
                                        <span onClick={()=>setAssignedToEditable(true)}>
                                        {
                                            assignee.map((assigned, count) =>{
                                                if (String(assigned.id) === String(assigneeValue)) {
                                                    return <span className='task-span-text'>{assigned.name}</span>;
                                                }
                                            })
                                        }
                                        </span>
                                ...
                                {
                                    currentStatusValue === "In Progress" || currentStatusValue === "QC Verification"?
                                    inProgressDateValue !== null ?
                                    <div className='d-flex col-11 mt-1'>
                                        <div className='col-4'>
                                ...
                                {
                                    currentStatusValue === "In Progress" || currentStatusValue === "QC Verification" || currentStatusValue === "On Hold" || currentStatusValue === "Completed"?
                                    <div className='d-flex col-11 mt-1'>
                                        <div className='col-4'>
